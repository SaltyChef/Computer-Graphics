...
class Geometry(Geometry):
    def __init__(self, width=1, height=1, depth=1):
        ...
        position_data = my_obj_reader('core/chess_knight.obj')
        color_data = [0.0, 0.0, 0.0] * len(position_data)
        uv_data = [GL.glGenTextures(1000)] * len(position_data) #35808
...
class ChessKnight(Base):
    ...
    def getObject3D(side=0):
        ...
        Chess_Knight = Object3D()
        Chess_Knight.add(mesh1)
